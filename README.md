...
(See appendix Pre-processing for code)
...
(see appendix Train & Test Split for code)
...
(See appendix Feature Extraction for code)
...
Fig 7 is a visual representation of the top words in both spam and non-spam emails. 
...
Model 	Accuracy Score (train data)
Support Vector Machine	0.980761(0.005167)
Gradient Boosting	0.975789(0.007127)
Naïve Bayes 	0.934015(0.006235)
Decision Tree	0.941983(0.013282)
Random Forrest	0.966068(0.011133)
	Table 1: Model Fitting  
(See appendix Model Building for code)
## 4.	Model selection 
...
0 (ham)	0.97	0.99	0.98	555
1 (spam)	0.99	0.96	0.97	419
Avg/total	0.98	0.98	0.98	974
...
(See appendix Pipeline, Model Testing and Validation for code)
